...
const StudentProfile = () => {
  ...
  useEffect(() => {
    if (userId) {
      axios.get(`http://localhost:8080/show/${userId}`)
        .then((response) => {
      ...
      axios.get(`http://localhost:8080/user/${userId}/programs`)
        .then((response) => {
  ...
  const saveProfile = () => {
    if (userId) {
      axios.put(`http://localhost:8080/edit/${userId}`, student)
        .then((response) => {
          setStudent(response.data);
          setEditMode(false);
        ...
        <div className="profile-container">
          <div className="profile-grid">
            <div className="profile-details">
              ...
              {editMode ? (
                <form onSubmit={(e) => { e.preventDefault(); saveProfile(); }} className="edit-form">
                ...
                <div className="profile-info">
                  <p><strong>First Name:</strong> {student.fullname}</p>
            ...
            <div className="programs-section">
              ...
              {programs.length > 0 ? (
                ...
                <div className="no-programs">
                  ...
                  <Link to="/program" className="btn btn-primary">Browse Programs</Link>
                </div>
              )}
            </div>
          </div>
